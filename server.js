...
const { getTopics, getArticleByTopicId, getArticles, getCommentsByArticleId, addCommentToArticle, updateArticleVote, updateCommentVote, deleteComment, getUsers } = require('./controllers');
